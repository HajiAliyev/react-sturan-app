...
var template = <div>
    ...
    <ul>
        <li>Loreasdsdaasdasdm, ipsum.</li>
        <li>Lorasdasdasdem, ipsum.</li>
        <li>Lorem, ipsum.</li>
        <li>Lorem, ipsum.</li>
    </ul>
</div>;
...
<div id="product-details">
    <h2 id="product-name">name: {product.nameProd}</h2>
    <p id="product-price">price: {product.priceProd} AZN</p>
    <p id="product-desc"> description: {product.descriptionProd}</p>
    <a href="https://www.youtube.com/watch?v=CsaEYLLL1CQ&list=PLXuv2PShkuHzbwIbcT29XZJBLyx3nWDzb&index=6">
        6-React Dersleri-Jsx Expressions - Sadık Turan</a>
</div>);
